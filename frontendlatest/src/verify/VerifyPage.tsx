...
export const VerifyPage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const {data} = await axios.post("http://localhost:4000/verify", {email, otp: otpString});
            alert(data.message);
            ...
            >
                ...
                <div>
                    ...
                    {timer > 0 ? (
                        ...
                        <div className="flex gap-1 py-3 items-center justify-center">
                            <button onClick={()=>handleResendOtp} className="cursor-pointer text-violet-600 " disabled={resendLoading}>
